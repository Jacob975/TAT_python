...
'''
Program:
    This is a program for listing the auxiliary stars used for photometry on observation data table. 
Usage: 
    photometry_prt_aux_star.py [option file]
...
def EP_process(data):
    ...
    print first_frame_data[int(begin_of_aux):(int(no_of_aux)+int(begin_of_aux))][:,target_name_index]
    #################################
    exit()
    #----------------------------------------
